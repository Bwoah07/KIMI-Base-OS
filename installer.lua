...
local cfg={role=role,profile=profile,localUI=localUI,name="KIMI-"..tostring(os.getComputerID()),theme={accent="red"},network={protocol="kimi_base_os_v1",hostname="kimi-base"},update={channel="alpha",auto=true,fleetManaged=true,checkOnBoot=true,interval=600},node=nodeCfg}
...
print("\nInstalled. Rebooting..."); sleep(2); os.reboot()
