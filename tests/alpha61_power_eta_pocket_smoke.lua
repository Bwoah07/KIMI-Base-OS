...
-- Pocket boots directly into a clean door-control screen and reacts optimistically.
local W,H=26,20
local rows,x,y={},1,1
...
local env={version="5.0.0-alpha.61",state={doors={doors={{id="D1",name="ROOM PANEL",_source="42",target="computer",side="left",open=false,online=true}}},power={stored=500,capacity=1000,filledPercentage=.5},attachments={sensors={}},fleet={}}}
...
out=output();assert(out:find("CLOSE DOOR",1,true)and out:find("OPEN",1,true),"Pocket did not flip UI optimistically")
...
local aenv={version="5.0.0-alpha.61",state={doors={doors={}},power={matrices={p},fluxNetworks={{stored=1000,capacity=1000,filledPercentage=1}}},attachments={sensors={}},fleet={}}}
