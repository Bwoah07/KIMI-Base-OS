...
local ui=read("clients/admin_v26.lua");assert(ui:find("LIVE ",1,true)and ui:find("LAST ",1,true)and ui:find("GHOST",1,true)and ui:find("PROVED NOW",1,true),"fleet screen does not distinguish live proof from registry history")
