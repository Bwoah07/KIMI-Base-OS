...
assert(read("clients/admin.lua"):find("clients.admin_v32",1,true),"admin is not loading current manual-authority fleet/UI wrapper")
local v32=read("clients/admin_v32.lua");assert(v32:find('require("clients.admin_v30")',1,true)and v32:find("core.monitor_authority",1,true),"current manual-screen wrapper lost truthful v30 lineage or authority")
